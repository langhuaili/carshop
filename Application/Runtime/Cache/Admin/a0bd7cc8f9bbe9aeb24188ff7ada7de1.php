    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                ...
                <li><a href="/carshop/Home/Index/index" target="_blank">网站首页</a></li>
            </ul>
        </div>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/cate/lst">栏目管理</a><span class="crumb-step">&gt;</span><span>新增栏目</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <?php if($cateres['pic'] != ''): ?><img src="/carshop<?php echo ($cateres["pic"]); ?>" height="50" />
                                    <?php else: ?>
                                    暂无缩略图<?php endif; ?>
                                </td>
                            </tr>
