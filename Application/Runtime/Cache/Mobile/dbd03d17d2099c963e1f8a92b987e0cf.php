...
<script language="javascript">
 ...
 function getlist(page){
    $.ajax({
        type:"GET",
        url:"/carshop/index.php/Mobile/Carlist/getlist/p/"+page+"/cateid/<?php echo I('get.cateid');?>",
        dataType:"json",
        success:function(data){
            ...
            $(data).each(function(k,v){
                html+='<li class="news4"><a href="/carshop/index.php/Mobile/Article/index/arid/'+v.id+'"><img src="/carshop'+v.pic+'"><span>'+v.title+'</span></a></li>';
            });
