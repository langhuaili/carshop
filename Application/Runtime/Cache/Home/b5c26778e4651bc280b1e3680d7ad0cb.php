...
邮箱：<?php echo (C("EMAIL")); ?> </div>
        ...
        <div class="fyRight">
      			...
      			<font><?php echo ($vo["name"]); ?></font><?php endif; endforeach; endif; else: echo "" ;endif; ?>
				    ...
				    <ul class="news_list">
				    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/carshop/index.php/Home/Article/index/arid/<?php echo ($vo["id"]); ?>" title="<?php echo ($vo["title"]); ?>"><span class="fl"><?php echo ($vo["title"]); ?></span><span class="fr"><?php echo (date("Y-m-d",$vo["time"])); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
